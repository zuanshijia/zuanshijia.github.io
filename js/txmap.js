...
$.ajax({
    ...
    data: {
        key: 'PJCBZ-HJO3Q-YBJ5K-2LSVX-YBWYJ-KOBJQ',
        output: 'jsonp',
    },
    dataType: 'jsonp',
...
function showWelcome() {
    ...
    let dist = getDistance(114.117201, 30.479861, ipLoacation.result.location.lng, ipLoacation.result.location.lat); //这里换成自己的经纬度
        ...
        case "中国":
            ...
            switch (ipLoacation.result.ad_info.province) {
                ...
                case "湖北省":
                    switch (ipLoacation.result.ad_info.city) {
                        case "武汉市":
                            posdesc = "站长在武汉学习。欢迎来到江城，来碗热干面！";
                            break;
                        case "荆州市":
                            posdesc = "荆州是站长的老家~现代与文化互相交织的城市，来一碗五一路米粉";
                            break;
                        case "宜昌市":
                            posdesc = "昌昌，跳跳，rap,music，你干嘛！";
                            break;
                        case "襄阳市":
                            posdesc = "来一碗襄阳牛肉面！";
                            break;
